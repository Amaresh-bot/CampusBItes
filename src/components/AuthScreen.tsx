...
import { User, ClipboardList, Shield, GraduationCap, Phone, Check, LogIn, Lock, Sparkles, Building, ArrowRight, AlertCircle, RefreshCw, Mail, ChefHat } from 'lucide-react';
...
export function AuthScreen({ onSuccess, onClose }: AuthScreenProps) {
  ...
  useEffect(() => {
    const handleLoginSuccess = async (authedUser: any, hasProfile: boolean, profile: any) => {
      if (authedUser) {
        if (authedUser.email && authedUser.email.toLowerCase() === 'shivaganeshmummadi7@gmail.com' || authedUser.email.toLowerCase() === 'amareshkaturi@gmail.com' || authedUser.email.toLowerCase() === 'akshith5481@gmail.com' || authedUser.email.toLowerCase() === 'coresoft.srinivas@gmail.com' || authedUser.email.toLowerCase() === 'campusbitesadmin26@gmail.com') {
        ...
        if (response.ok) {
          ...
          if (!isFirebaseMock) {
            try {
              ...
              const isAdminEmail = payload.email && payload.email.toLowerCase() === 'shivaganeshmummadi7@gmail.com' || payload.email.toLowerCase() === 'amareshkaturi@gmail.com' || payload.email.toLowerCase() === 'akshith5481@gmail.com' || payload.email.toLowerCase() === 'coresoft.srinivas@gmail.com' || payload.email.toLowerCase() === 'campusbitesadmin26@gmail.com';
          ...
          const finalUser = {
            ...
            name: payload.fullName,
            email: payload.email,
            role: (payload.email && payload.email.toLowerCase() === 'shivaganeshmummadi7@gmail.com' || payload.email.toLowerCase() === 'amareshkaturi@gmail.com' || payload.email.toLowerCase() === 'akshith5481@gmail.com' || payload.email.toLowerCase() === 'coresoft.srinivas@gmail.com' || payload.email.toLowerCase() === 'campusbitesadmin26@gmail.com') ? 'admin' as const : 'customer' as const
          };
