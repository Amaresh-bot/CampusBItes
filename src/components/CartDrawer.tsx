      ...
      {cartItems.length === 0 ? (
        <div className="text-center py-10 space-y-4">
          <div className="w-24 h-24 bg-[#E8F5E9] rounded-full flex items-center justify-center mx-auto relative">
            ...
            <span className="absolute -top-1 -right-1 bg-[#1B4D3E] text-white text-[9px] font-black font-mono h-5 w-5 rounded-full flex items-center justify-center animate-bounce">
              !
            </span>
          </div>
          ...
          <button
            ...
            className="px-5 py-2.5 bg-[#1B4D3E] text-white rounded-xl text-xs font-black uppercase tracking-wider hover:bg-[#143B2F] transition-all cursor-pointer shadow-md inline-block"
          >
            Explore Menu
          </button>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center justify-center gap-2 mt-4">
            <ShieldCheck className="w-3.5 h-3.5 text-[#1B4D3E] opacity-65" />
      ...
      {showRzpSimulator && (
        <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-xs flex items-center justify-center z-50 p-4">
          <div className="w-full max-w-sm bg-slate-900 text-slate-100 rounded-3xl border border-slate-800 p-6 shadow-2xl relative overflow-hidden text-left">
            ...
            {/* Header decoration */}
            <div className="absolute top-0 inset-x-0 h-1 bg-[#1B4D3E]" />

            <div className="flex justify-between items-start mb-4">
              <div>
                <span className="text-[8px] bg-[#1B4D3E] text-white px-2 py-0.5 rounded font-bold uppercase tracking-widest leading-none">
                  Secure Intercept
                </span>
            ...
            <div className="space-y-4 font-sans text-xs">
              <div className="p-4 bg-slate-850 rounded-xl space-y-1">
                ...
                <div className="flex justify-between items-center font-bold text-white border-t border-slate-850 pt-2.5 mt-2.5">
                  ...
                  <span className="text-[#1B4D3E] text-base font-mono font-bold">₹{simulatedAmount}</span>
                </div>
              </div>

              <div className="p-3 bg-[#E8F5E9]/30 border border-[#1B4D3E]/20 rounded-xl text-slate-355 leading-normal">
              ...
              <div className="grid grid-cols-2 gap-3 pt-1">
                ...
                <button
                  ...
                  className="w-full py-3 bg-[#1B4D3E] hover:bg-[#143B2F] text-white font-extrabold rounded-xl cursor-pointer active:scale-[0.98] transition-all shadow-sm"
                >
                  Authorize
                </button>
              </div>
