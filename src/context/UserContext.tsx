      ...
      try {
        ...
        if (res.ok && res.headers.get('content-type')?.includes('application/json')) {
          ...
          if (data && data.authenticated && data.user) {
            const resolvedRole = (data.user.email && data.user.email.toLowerCase() === 'shivaganeshmummadi7@gmail.com' || data.user.email.toLowerCase() === 'amareshkaturi@gmail.com' || data.user.email.toLowerCase() === 'akshith5481@gmail.com' || data.user.email.toLowerCase() === 'coresoft.srinivas@gmail.com' || data.user.email.toLowerCase() === 'campusbitesadmin26@gmail.com') || (data.user.role === 'admin') ? 'admin' : 'customer';
            setUserState({
              id: data.user.id,
