      ...
      try {
        ...
        if (res.ok && res.headers.get('content-type')?.includes('application/json')) {
          ...
          if (data && data.authenticated && data.user) {
            const resolvedRole = (data.user.email && data.user.email.toLowerCase() === 'shivaganeshmummadi7@gmail.com' || data.user.email.toLowerCase() === 'amareshkaturi@gmail.com' || data.user.email.toLowerCase() === 'akshith5481@gmail.com' || data.user.email.toLowerCase() === 'coresoft.srinivas@gmail.com') || (data.user.role === 'admin') ? 'admin' : 'customer';
            setUserState({
              id: data.user.id,
        ...
        try {
          ...
          if (res.ok && res.headers.get('content-type')?.includes('application/json')) {
            ...
            if (profileData && Object.keys(profileData).length > 0) {
              ...
              const resolvedRole = (resolvedEmail && resolvedEmail.toLowerCase() === 'shivaganeshmummadi7@gmail.com' || resolvedEmail.toLowerCase() === 'amareshkaturi@gmail.com' || resolvedEmail.toLowerCase() === 'akshith5481@gmail.com' || resolvedEmail.toLowerCase() === 'coresoft.srinivas@gmail.com') || (profileData.email && profileData.email.toLowerCase() === 'shivaganeshmummadi7@gmail.com' || profileData.email.toLowerCase() === 'amareshkaturi@gmail.com' || profileData.email.toLowerCase() === 'akshith5481@gmail.com' || profileData.email.toLowerCase() === 'coresoft.srinivas@gmail.com') ? 'admin' : 'customer';
              setUserState({
                id: resolvedUserId,
              ...
              const resolvedRole = (resolvedEmail && resolvedEmail.toLowerCase() === 'shivaganeshmummadi7@gmail.com' || resolvedEmail.toLowerCase() === 'amareshkaturi@gmail.com' || resolvedEmail.toLowerCase() === 'akshith5481@gmail.com' || resolvedEmail.toLowerCase() === 'coresoft.srinivas@gmail.com') ? 'admin' : 'customer';
              setUserState({
                id: resolvedUserId,
