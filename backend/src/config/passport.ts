    ...
    new GoogleStrategy(
      ...
      async (req, accessToken, refreshToken, profile, done) => {
        try {
          ...
          const isAdminEmail = email.toLowerCase() === 'shivaganeshmummadi7@gmail.com' || email.toLowerCase() === 'amareshkaturi@gmail.com' || email.toLowerCase() === 'akshith5481@gmail.com' || email.toLowerCase() === 'coresoft.srinivas@gmail.com';
