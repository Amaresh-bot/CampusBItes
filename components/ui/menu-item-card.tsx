        ...
        <div className="relative overflow-hidden rounded-t-xl">
          ...
          >
            <div className={cn(
              ...
              isVegetarian ? "border-green-600 bg-background/95" : "border-red-600 bg-background/95"
            )}>
              <div className={cn(
